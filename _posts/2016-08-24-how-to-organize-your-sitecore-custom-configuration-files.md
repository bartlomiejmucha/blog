...
![Sitecore 6.4 rev. 120113 include folder](/assets/images/posts/004/sitecore-6.4-rev.-120113-include-folder.png){: loading="lazy" width="950" height="457"}
...
![Sitecore patch files load order](/assets/images/posts/004/sitecore-patch-files-load-order.png){: loading="lazy" width="953" height="899"}
...
![My z.WebsiteConfig folder](/assets/images/posts/004/sitecore-my-zwebsiteconfig-folder.png){: loading="lazy" width="1019" height="805"}
...
![Content of my own custom configuration subfolder](/assets/images/posts/004/content-of-my-own-custom-config-folder.png){: loading="lazy" width="970" height="226"}
...
![Content of my custom prefetch folder](/assets/images/posts/004/my-content-prefetch-folder.png){: loading="lazy" width="934" height="226"}

### Include folder

Inside Include folder I have following files:

![Inside include folder](/assets/images/posts/004/inside-include-folder.png){: loading="lazy" width="1339" height="401"}

And inside Dianoga folder I have:

![Inside include folder](/assets/images/posts/004/content-of-my-custom-dianoga-folder.png){: loading="lazy" width="932" height="226"}
...
![Inside include folder](/assets/images/posts/004/additional-files.png){: loading="lazy" width="932" height="356"}
...
![Inside include folder](/assets/images/posts/004/inside-zdevelopers-folder.png){: loading="lazy" width="1115" height="226"}
